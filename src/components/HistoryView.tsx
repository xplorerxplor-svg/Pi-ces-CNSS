    ...
    <div className="flex-1 p-3.5 sm:p-5 md:p-6 lg:p-8 overflow-y-auto bg-slate-50 flex flex-col gap-4 sm:gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          <button
            onClick={exportCSV}
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3.5 py-2 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 rounded-lg text-xs font-bold transition-colors shadow-2xs cursor-pointer min-h-[38px]"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none px-3.5 py-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white rounded-lg text-xs font-bold shadow-md shadow-blue-200 transition-all cursor-pointer min-h-[38px]"
          >
            Actualiser
          </button>
        </div>
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-slate-200 shadow-sm grid grid-cols-1 sm:grid-cols-12 gap-2.5 sm:gap-3 items-center">
        ...
        <div className="sm:col-span-6 relative">
          ...
          <input
            ...
            placeholder="Rechercher (dossier, élève, entreprise...)"
        ...
        <div className="sm:col-span-3">
          ...
          >
            ...
            <option value="VERIFICATION_REQUISE">⚠ Vérification humaine</option>
            <option value="NON_VALIDE">✕ Non conformes</option>
          </select>
        </div>
      ...
      {/* LISTE DES DOCUMENTS (DESKTOP TABLE + MOBILE CARDS) */}
              ...
              {filteredDocs.map(doc => {
                ...
                return (
                  <div
                    ...
                    className="p-3.5 hover:bg-slate-50 transition-colors active:bg-slate-100 cursor-pointer flex flex-col gap-2"
                  >
                    ...
                    {mainPersonField?.value && (
                      <div className="text-xs text-slate-600 font-medium">
                        Titulaire : <span className="font-bold text-slate-800">{mainPersonField.value}</span>
                      </div>
                    )}
